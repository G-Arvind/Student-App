...
/**
 * Created by Arvind on 02-04-2018.
 */
...
public class Attendance extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="http://192.168.1.2:8080/att/"+rno;
    ...
    void setval()
    {
        ...
        sub1.setProgress(Integer.parseInt(list2.get(0))*10);
        sub2.setProgress(Integer.parseInt(list2.get(2))*10);
        sub3.setProgress(Integer.parseInt(list2.get(4))*10);
        sub4.setProgress(Integer.parseInt(list2.get(6))*10);
        sub5.setProgress(Integer.parseInt(list2.get(8))*10);
        sub6.setProgress(Integer.parseInt(list2.get(10))*10);
